...
v.hToolbarMenu = uimenu('Parent',v.hFunctionMenu,'Label','Set node sizes','HandleVisibility','callback','Callback', @gui.Set_sizes_Callback);
v.hToolbarMenu = uimenu('Parent',v.hFunctionMenu,'Label','Select colors','HandleVisibility','callback','Callback', @gui.Add_colors_Callback);
v.hToolbarMenu = uimenu('Parent',v.hFunctionMenu,'Label','Select matrix','HandleVisibility','callback','Callback', @gui.Add_matrix_Callback);
