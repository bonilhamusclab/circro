...
v.hFunctionCircroEditEdgeColorSettingsMenu = uimenu(v.hFunctionCircroMenu,'Label','Edit Edge Color Settings','HandleVisibility','callback','Callback', @gui.circro.EditEdgeColorSettings_Callback);
