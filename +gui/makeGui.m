...
v.hFunctionCircroEditNodeColorSettingsMenu = uimenu(v.hFunctionCircroMenu,'Label','Edit Node Color Settings','HandleVisibility','callback','Callback', @gui.circro.EditNodeColorSettings_Callback);
