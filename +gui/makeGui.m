...
v.hFunctionCircroSetNodeColorsColorschemeMenu = uimenu(v.hFunctionCircroMenu,'Label','Set Node Colors Colorscheme','HandleVisibility','callback','Callback', @gui.circro.SetNodeColorsColorscheme_Callback);
...
v.hFunctionCircroSetEdgeMatrixColorschemeMenu = uimenu(v.hFunctionCircroMenu,'Label','Set Edge Matrix Colorscheme','HandleVisibility','callback','Callback', @gui.circro.SetEdgeMatrixColorscheme_Callback);
